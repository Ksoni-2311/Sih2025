      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">CampusReady</h1>
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button
              className="bg-gradient-hero hover:opacity-90 transition-all shadow-emergency"
